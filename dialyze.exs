defmodule Dialyze do
  ...
  defp filter_warning(warning = {:warn_opaque, {'lib/mix/tasks/test.ex', 699}, {:opaque_match, ['pattern \#{\'__struct__\':=\'Elixir.MapSet\'}', '\'Elixir.MapSet\':t(binary() | maybe_improper_list(binary() | maybe_improper_list(any(),binary() | []) | char(),binary() | []))', '\'Elixir.MapSet\':t(binary() | maybe_improper_list(binary() | maybe_improper_list(any(),binary() | []) | char(),binary() | []))']}}),
  ...
  defp filter_warning(warning = {:warn_matching, {'lib/mix/dep/loader.ex', line}, {:pattern_match_cov, ['variable _', '\'Elixir.Regex\'']}}) when line in [125, 155, 163],
    do: filtered(id: 21, comment: "redundant clause generated by is_struct macro for this literal atom", data: warning)

  expected_counts = Map.put(expected_counts, 21, 3)

  defp filter_warning(warning = {:warn_matching, {'lib/ex_unit/assertions.ex', 744}, {:pattern_match_cov, ['variable _', '\'Elixir.Regex\'']}}),
    do: filtered(id: 22, comment: "redundant clause generated by is_struct macro for this literal atom", data: warning)
