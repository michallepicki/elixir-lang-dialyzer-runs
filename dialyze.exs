defmodule Dialyze do
  ...
  defp filter_warning(warning = {:warn_matching, {'lib/kernel.ex', line}, {:pattern_match, ['pattern \'false\'', '\'true\'']}}) when line in [1842, 3136, 3470, 3779, 4125, 4129, 4566],
  ...
  defp filter_warning(warning = {:warn_matching, {'lib/mix/dep/loader.ex', line}, {:pattern_match_cov, ['variable _', '\'Elixir.Regex\'']}}) when line in [125, 155, 163],
    do: {:ok, "redundant clause generated by is_struct macro for this literal atom", warning}

  defp filter_warning(warning = {:warn_matching, {'lib/ex_unit/assertions.ex', 737}, {:pattern_match_cov, ['variable _', '\'Elixir.Regex\'']}}),
    do: {:ok, "redundant clause generated by is_struct macro for this literal atom", warning}
