defmodule Dialyzer do
  ...
  defp filter(
         expected =
           {:warn_failing_call, {'lib/logger.ex', 862},
  ...
  defp filter(
         expected =
           {:warn_matching, {'lib/mix/utils.ex', 760},
            {:pattern_match,
             [
               'pattern \'nil\'',
  ...
  defp filter(
       ...
       when line in [1992, 3497, 3890, 3960, 4347],
  ...
  defp filter(
         expected =
           {:warn_return_no_exit, {'src/elixir_errors.erl', {183, 1}},
  ...
  defp filter(
         expected =
           {:warn_return_no_exit, {'src/elixir_errors.erl', {189, 1}},
