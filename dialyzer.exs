defmodule Dialyzer do
  ...
  defp filter(
         dialyzer_warning =
           {:warn_opaque, {~c"lib/module/types/descr.ex", _},
  ...
  defp filter(
         dialyzer_warning =
           {:warn_matching, {~c"lib/mix/tasks/release.ex", 1214}, {:pattern_match_cov, [~c"variable _@11", ~c"'ok'"]}}
       ),
  ...
  defp filter(
         dialyzer_warning =
           {:warn_matching, {~c"lib/module/types/expr.ex", _}, {:pattern_match_cov, [~c"variable _@1", ~c"{'ok',\#{'bitmap':=256},_}"]}}
       ),
       do: filtered(comment: "redundant code generated by a with statement", id: @id, data: dialyzer_warning)
  ...
  defp filter(
         dialyzer_warning =
           {:warn_matching, {~c"lib/module/types/pattern.ex", _}, {:pattern_match_cov, [~c"variable _@1", ~c"{'ok',\#{'dynamic':=\#{'atom':={_,_}, 'bitmap':=2047}},_}"]}}
       ),
       do: filtered(comment: "redundant code generated by a with statement", id: @id, data: dialyzer_warning)
  ...
  defp filter(
         dialyzer_warning =
           {:warn_matching, {~c"lib/module/types/pattern.ex", _}, {:pattern_match_cov, [~c"variable _@1", ~c"{'ok',\#{'bitmap':=256},_}"]}}
       ),
       do: filtered(comment: "redundant code generated by a with statement", id: @id, data: dialyzer_warning)
  ...
  defp filter(
         dialyzer_warning =
           {:warn_matching, {~c"lib/iex/helpers.ex", 693},
            {:pattern_match,
             [
  ...
  defp filter(
       ...
       when line in [2066, 3614, 4009, 4106, 4493],
