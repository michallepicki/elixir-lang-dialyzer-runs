defmodule Dialyzer do
  ...
  defp filter(
         dialyzer_warning =
           {:warn_matching, {~c"lib/module/types/expr.ex", _}, {:pattern_match_cov, [~c"variable _@1", ~c"{'ok',\#{'bitmap':=512},_}"]}}
       ),
       do: filtered(comment: "redundant code generated by a with statement", id: @id, data: dialyzer_warning)
  ...
  defp filter(
         dialyzer_warning =
           {:warn_matching, {~c"lib/module/types/pattern.ex", _}, {:pattern_match_cov, [~c"variable _@1", ~c"{'ok','dynamic',_}"]}}
       ),
       do: filtered(comment: "redundant code generated by a with statement", id: @id, data: dialyzer_warning)
  ...
  defp filter(
         dialyzer_warning =
           {:warn_matching, {~c"lib/module/types/pattern.ex", _}, {:pattern_match_cov, [~c"variable _@1", ~c"{'ok',\#{'bitmap':=512},_}"]}}
       ),
       do: filtered(comment: "redundant code generated by a with statement", id: @id, data: dialyzer_warning)
