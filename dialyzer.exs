defmodule Dialyzer do
  ...
  defp filter(
         dialyzer_warning =
           {:warn_failing_call, {'lib/logger.ex', 849},
  ...
  defp filter(
         dialyzer_warning =
           {:warn_return_no_exit, {'lib/mix/tasks/test.ex', 614},
  ...
  defp filter(
         dialyzer_warning =
           {:warn_return_no_exit, {'src/elixir_errors.erl', {214, 1}},
  ...
  defp filter(
         dialyzer_warning =
           {:warn_return_no_exit, {'src/elixir_errors.erl', {220, 1}},
